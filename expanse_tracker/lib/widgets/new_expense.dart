...
class _NewExpense extends State<NewExpense> {
  ...
  Widget build(context) {
    ...
    // LayoutBuilder é usado para construir widgets com base nas restrições de layout fornecidas pelo PAI DO WIDGET.
    // Isso é particularmente útil quando você deseja ajustar o comportamento de um widget com base no espaço disponível
    //na tela ou em outros fatores de layout.
